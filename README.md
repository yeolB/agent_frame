...
기본 설치는 **Level 1 — Continuity**입니다. 변경된 작업 세션은 모델 호출 없이 로컬 스크립트가 세고, 짧은 주기로 메모리 정리를 알리며, 더 긴 주기로 깨끗한 컨텍스트의 독립 drift review를 요청합니다. Architecture governance는 실제 구조 문제가 반복될 때만 **Level 2**로 추가합니다.
...
v2.x와 v3.0은 설계가 발전한 과정을 보존하는 이전 기록입니다.
